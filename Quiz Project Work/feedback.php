  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:black">LogIn</span></h4>
      </div>
...
<div class="col-md-6 panel" style="background-color: #FF3CAC;
...
<div class="col-md-10">
<a href="mailto:stshomo@gmail.com" style="color:#000000">stshomo@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sonam Tshomo</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 98761521</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">stshomo@gmail.com</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Assam Downtown University</h4></div></div>
		</p>
      </div>
